...
/// <summary>
/// Script Unity pour la lettre X en LSF.
/// Comme la lettre V mais avec l'index et le majeur légèrement courbés.
/// Annulaire + auriculaire repliés, pouce dessus. Paume vers la caméra.
/// </summary>
public class X : MonoBehaviour
{
    ...
    [Header("Index — courbé incliné gauche")]
    public Vector3 indexPh1 = new Vector3(30f, -15f, 0f);
    public Vector3 indexPh2 = new Vector3(30f, 0f, 0f);
    public Vector3 indexPh3 = new Vector3(20f, 0f, 0f);

    [Header("Majeur — courbé incliné droite")]
    public Vector3 middlePh1 = new Vector3(30f, 15f, 0f);
    public Vector3 middlePh2 = new Vector3(30f, 0f, 0f);
    public Vector3 middlePh3 = new Vector3(20f, 0f, 0f);
    ...
    private void Start()
    {
        if (playOnStart) PlayX();
    }

    public void PlayX()
    {
        if (currentCoroutine != null) StopCoroutine(currentCoroutine);
        currentCoroutine = StartCoroutine(PlayXCoroutine());
    }

    private IEnumerator PlayXCoroutine()
    {
        if (rightHandTarget == null) { Debug.LogError("[X] RightHandTarget non assigné."); yield break; }
        if (targetPositionSpace == TargetPositionSpace.RelativeToAvatarRoot && avatarRoot == null) { Debug.LogError("[X] AvatarRoot requis."); yield break; }

        if (showDebugLogs) Debug.Log("[X] Démarrage.");
